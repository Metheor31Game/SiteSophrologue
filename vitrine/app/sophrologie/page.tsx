...
export default function SophrologiePage() {
  return (
    <div className="text-center p-6">
      <h1 className="text-3xl font-bold text-vert-fonce mb-4">Qu'est-ce que la Sophrologie ?</h1>
      ...
      <div className="bg-beige-sable shadow-md rounded-xl p-6 mb-6 w-full max-w-2xl mx-auto">
        <h2 className="text-2xl font-semibold text-marron-doux mb-4">Les bienfaits de la sophrologie</h2>
        <ul className="text-marron-doux text-left list-disc pl-6">
      ...
      <div className="bg-beige-sable shadow-md rounded-xl p-6 w-full max-w-2xl mx-auto">
        <h2 className="text-2xl font-semibold text-marron-doux mb-4">Déroulement d'une séance</h2>
        <p className="text-marron-doux leading-relaxed">
          Une séance de sophrologie se compose généralement de trois phases :
        </p>
        <ul className="text-marron-doux text-left list-decimal pl-6 mt-4">
