export default function SophrologuePage() {
  return (
    <div className="bg-blanc-casse rounded-xl text-center p-6">
      ...
      <h3 className="text-1xl text-vert-clair">Raji Elmasri</h3>
      <br></br>

      <div className="bg-beige-sable p-6 rounded-xl shadow-md max-w-3xl mx-auto">
        <h2 className="text-3xl font-semibold text-vert-fonce mb-4">
          Mon Parcours
        </h2>
        <p className="text-lg text-marron-doux leading-relaxed">
